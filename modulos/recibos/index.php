...
// Generar recibos del periodo (para clientes)
if (isset($_GET['generar']) && $_GET['generar'] === '1') {
  $generados = $service->generarRecibosPeriodo($desde, $hasta, $cliente_id, null);
...
<div class="row mb-4">
  <div class="col-md-6">
    <h2>Recibos de clientes</h2>
    <p class="text-muted mb-0"></p>
  </div>
  <div class="col-md-6 text-end">
    <a href="<?php echo URL_ROOT; ?>/modulos/recibos/externos.php" class="btn btn-outline-dark me-2">
      <i class="fas fa-file-invoice-dollar"></i> Recibos externos
    </a>
    <a href="<?php echo URL_ROOT; ?>/modulos/clientes/index.php" class="btn btn-secondary me-2">
      <i class="fas fa-users"></i> Clientes
    </a>
    <a href="<?php echo URL_ROOT; ?>/modulos/recibos/pago_adelantado.php" class="btn btn-outline-primary me-2">
      <i class="fas fa-forward"></i> Pago adelantado
    </a>
    <a href="<?php echo URL_ROOT; ?>/modulos/recibos/nuevo_externo.php" class="btn btn-primary">
      <i class="fas fa-file-circle-plus"></i> Nuevo recibo
    </a>
    <a href="?desde=<?php echo htmlspecialchars($desde, ENT_QUOTES, 'UTF-8'); ?>&hasta=<?php echo htmlspecialchars($hasta, ENT_QUOTES, 'UTF-8'); ?>&cliente_id=<?php echo (int)$cliente_id; ?>&estado=<?php echo urlencode($estado); ?>&generar=1" class="btn btn-primary"
