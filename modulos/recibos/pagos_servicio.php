...
$db = new Database();
$db->query('SELECT r.*, c.razon_social, c.rfc FROM recibos r JOIN clientes c ON c.id = r.cliente_id WHERE r.id = :id');
...
<div class="row mb-3">
  <div class="col-md-8">
    <h3>Historial de Pagos del Recibo de Servicio</h3>
...
<div class="card">
  <div class="card-body table-responsive">
    <table class="table table-striped table-bordered align-middle">
      <thead>
        <tr><th>Folio</th><th>Fecha</th><th class="text-end">Monto</th><th>Método</th><th>Referencia</th><th>Acciones</th></tr>
      </thead>
      <tbody>
        ...
        <tr>
          ...
          <td>
            <a class="btn btn-sm btn-outline-primary" href="<?php echo URL_ROOT; ?>/modulos/recibos/imprimir_pago.php?id=<?php echo (int)$p->id; ?>" target="_blank">
               <i class="fas fa-print"></i> Imprimir Comprobante
            </a>
          </td>
        </tr>
        <?php endforeach; else: ?>
        <tr><td colspan="6" class="text-center text-muted">Sin pagos registrados para este recibo.</td></tr>
        <?php endif; ?>
      </tbody>
    </table>
  </div>
