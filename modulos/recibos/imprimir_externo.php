...
// Conexión directa (si tu include ya crea conexión, omite esta)
...
if ($recibo_id <= 0) {
  die('<div class="alert alert-danger">No se encontró el recibo especificado.</div>');
}
...
$cliente = $data->externo_nombre ?? "_________________________";
$rfc = $data->externo_rfc ?? "_________________________";
...
@media print {
    ...
    .page { height: 287mm; }
    .recibo { height: 130mm; page-break-inside: avoid; }
}
</style>
</head>
<body>
...
foreach ($tipos as $index => $tipo): ?>
    <div class="recibo">
        ...
        <table>
            ...
            <!--<tr><th>Precio Servicio</th><td>$<?= $precio_servicio ?></td></tr>!-->
            <tr><th>Importe Pago</th><td>$<?= $importe_pago ?></td></tr>
            <tr><th>Cantidad en letras</th><td><?= $cantidad_letras ?></td></tr>
            <!--<tr><th>Saldo</th><td>$<?= $saldo ?></td></tr>!-->
            <tr><th>Estado</th><td><?= $estado ?></td></tr>
            <tr><th>Fecha Pago</th><td><?= $fecha_pago ?></td></tr>
        </table>
