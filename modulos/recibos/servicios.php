...
if ($desde !== '') {
  $sql .= ' AND r.fecha_pago >= :desde';
  $params[':desde'] = $desde;
}
if ($hasta !== '') {
  $sql .= ' AND r.fecha_pago <= :hasta';
  $params[':hasta'] = $hasta;
}
if ($cliente_id) {
...
$sql .= ' ORDER BY r.fecha_pago DESC, c.razon_social ASC';
...
<div class="row mb-4">
  <div class="col-md-6">
    <h2>Recibos de Servicios</h2>
  </div>
  <div class="col-md-6 text-end">
    <a href="<?php echo URL_ROOT; ?>/modulos/recibos/index.php" class="btn btn-secondary me-2">
      <i class="fas fa-file-invoice"></i> Recibos de Honorarios
    </a>
    <a href="<?php echo URL_ROOT; ?>/modulos/recibos/nuevo_servicio.php" class="btn btn-primary">
      <i class="fas fa-plus"></i> Nuevo Recibo de Servicio
    </a>
  </div>
</div>
      ...
      <tbody>
        ...
        ?>
            <tr>
              ...
              <td><?php echo formatDate($r->fecha_pago); ?></td>
...
<script>
  // Script para el modal de pago (idéntico al de index.php)
