...
// CORRECCIÓN: Se ha ajustado el orden de los argumentos $monto y $fecha_pago
...
if ($exito) {
  flash('mensaje', 'Pago de servicio registrado correctamente.');
} else {
  flash('mensaje', 'Error al registrar el pago del servicio.', 'alert alert-danger');
}
